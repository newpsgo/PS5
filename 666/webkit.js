...
poc = function() {
    ...
    for (var i = HAMMER_NSTRINGS; i > 0; i--)
    ...
    window.p = prim;
    window.terminaltitle.style.display='block';
    window.consoles.style.display='block';
    run_hax();
// })();
};
run = ()=>{
    window.onekey.onmouseover=null;
    window.onekey.onmouseout=null;
    
    window.consoles.innerText="画面假死，请勿操作！";
